const translations = {
    ar: {
        ...
        hero_desc: "بريت هومي هي خيارك الأول لخدمات تنظيف الخزانات، الكنب، السجاد، والأحواش في أبو ظبي. نستخدم أحدث التقنيات لنضمن لك بيئة صحية ونظافة تدوم طويلاً تليق بك وبعائلتك.",
        btn_discover: "اكتشف خدماتنا",
        btn_contact: "تواصل معنا",
        about_sub: "من نحن",
        about_title_1: "نحن بريت هومي..",
        about_title_2: "الريادة في عالم النظافة",
        about_desc_1: "بخبرة تمتد لسنوات في قلب أبو ظبي، انطلقت بريت هومي لتكون الشريك الأمثل لكل منزل يبحث عن التميز والراحة والتعقيم المتكامل بلمسات احترافية في دولة الإمارات.",
        ...
        ser_desc_long: "نحن في بريت هومي نفخر بتقديم باقة متكاملة من حلول التنظيف والتعقيم المتطورة في الإمارات. نجمع بين الخبرة الطويلة وأحدث المعدات العالمية لنضمن لك جودة تفوق التوقعات.",
        s1_t: "التنظيف الشامل",
        ...
        f_yard: "جلي أحواش",
        why_badge: "سر تميزنا",
        why_main_title: 'ما الذي يجعل <span class="text-glow">بريت هومي</span> خيارك الأول؟',
        ...
        trust_text: "أكثر من 5000 منزل في الإمارات يثقون بنا سنوياً",
        ...
        address_val: "أبو ظبي، الإمارات العربية المتحدة",
        ...
        footer_about_desc: "الوجهة الأولى والخبراء المعتمدون في خدمات التنظيف والتعقيم الشامل في أبو ظبي، الإمارات. نجمع بين الأمانة، السرعة، والجودة الفائقة.",
    ...
    en: {
        ...
        hero_desc: "Bright Home is your first choice for tank, sofa, carpet, and yard cleaning in Abu Dhabi. We use the latest technology to ensure a healthy environment for you and your family.",
        btn_discover: "Our Services",
        btn_contact: "Contact Us",
        about_sub: "About Us",
        about_title_1: "We are Bright Home..",
        about_title_2: "Leaders in Cleaning",
        about_desc_1: "With years of experience in Abu Dhabi, Bright Home was launched to be the ideal partner for home excellence and professional sterilization in the UAE.",
        ...
        ser_desc_long: "At Bright Home, we are proud to provide a comprehensive package of advanced cleaning and sterilization solutions in the UAE. We combine field experience with the latest global equipment.",
        s1_t: "Total Cleaning",
        s1_short: "Deep cleaning solutions for villas, apartments, and palaces inside and out with maximum precision.",
        s1_long: "We use advanced marble polishing techniques, high window cleaning, and chandelier polishing with premium Italian materials.",
        s2_t: "Water Tank Sanitization",
        s2_short: "Cleaning and disinfecting tanks to ensure pure and healthy water delivery.",
        s2_long: "We guarantee pure water through 4 cleaning stages: sediment removal, manual wall scrubbing, deep chlorine disinfection, and final purity test.",
        ...
        s3_long: "Our dry steam technology penetrates carpet and sofa fibers to remove the toughest stains while maintaining colors and adding a luxury scent.",
        s4_t: "Yards & Gardens",
        s4_short: "Professional cleaning and landscaping of outdoor areas, private gardens, and pathways.",
        s4_long: "We enhance your entrance beauty, from pathway cleaning to patio tile polishing and safe pest control to ensure an environment free from insects.",
        order_now: "Order Now",
        f_facades: "Facades",
        f_floors: "Floors",
        ...
        w1_t: "Elite Experts",
        w1_d: "Our staff are professional technicians trained to the highest hotel standards to ensure excellence and precision.",
        ...
        w4_t: "Punctuality",
        w4_d: "We value your time; our smart scheduling system ensures our team arrives exactly on time with high execution speed.",
        trust_text: "More than 5,000 homes in the UAE trust us annually",
        ...
        address_val: "Abu Dhabi, United Arab Emirates",
        form_title: "Request Service Now",
        label_name: "Full Name",
        label_service: "Select Service",
        label_msg: "Order details or address",
        send_btn: "Send Request",
        footer_about_desc: "The first destination and certified experts in comprehensive cleaning and sterilization services in Abu Dhabi, UAE.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (whatsappForm) {
        whatsappForm.addEventListener('submit', (e) => {
            ...
            const fullMsg = `مرحباً بريت هومي، أرغب في طلب خدمة:%0A- *الاسم:* ${name}%0A- *الخدمة:* ${service}%0A- *التفاصيل:* ${msg}`;
            const phone = "971541608005"; 
...
if (!document.querySelector('.floating-btns')) {
    const floatDiv = document.createElement('div');
    floatDiv.className = 'floating-btns';
    floatDiv.innerHTML = `
        <a href="https://wa.me/971541608005" target="_blank" class="float-btn wa"><i class="fab fa-whatsapp"></i></a>
